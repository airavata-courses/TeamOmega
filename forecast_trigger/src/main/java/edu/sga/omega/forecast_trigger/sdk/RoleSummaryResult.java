                        ...
                        if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                            {
                                ...
                                struct.summaries = new HashSet<RoleSummary>(2 * _set302.size);
                                RoleSummary _elem303;
                                for (int _i304 = 0; _i304 < _set302.size; ++_i304) {
                                    _elem303 = new RoleSummary();
                                    _elem303.read(iprot);
                                    struct.summaries.add(_elem303);
                                }
                                iprot.readSetEnd();
                            }
        ...
        public void write(org.apache.thrift.protocol.TProtocol oprot, RoleSummaryResult struct) throws org.apache.thrift.TException {
            ...
            if (struct.summaries != null) {
                oprot.writeFieldBegin(SUMMARIES_FIELD_DESC);
                {
                    ...
                    for (RoleSummary _iter305 : struct.summaries) {
            ...
            if (struct.isSetSummaries()) {
                {
                    ...
                    for (RoleSummary _iter306 : struct.summaries) {
            ...
            if (incoming.get(0)) {
                {
                    ...
                    struct.summaries = new HashSet<RoleSummary>(2 * _set307.size);
                    RoleSummary _elem308;
                    for (int _i309 = 0; _i309 < _set307.size; ++_i309) {
                        _elem308 = new RoleSummary();
                        _elem308.read(iprot);
                        struct.summaries.add(_elem308);
                    }
                }
                struct.setSummariesIsSet(true);
            }
