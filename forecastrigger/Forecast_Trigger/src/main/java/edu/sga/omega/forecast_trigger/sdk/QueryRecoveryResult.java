                        ...
                        if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                            {
                                ...
                                struct.tasks = new HashSet<ScheduledTask>(2 * _set278.size);
                                ScheduledTask _elem279;
                                for (int _i280 = 0; _i280 < _set278.size; ++_i280) {
                                    _elem279 = new ScheduledTask();
                                    _elem279.read(iprot);
                                    struct.tasks.add(_elem279);
                                }
                                iprot.readSetEnd();
                            }
        ...
        public void write(org.apache.thrift.protocol.TProtocol oprot, QueryRecoveryResult struct) throws org.apache.thrift.TException {
            ...
            if (struct.tasks != null) {
                oprot.writeFieldBegin(TASKS_FIELD_DESC);
                {
                    ...
                    for (ScheduledTask _iter281 : struct.tasks) {
            ...
            if (struct.isSetTasks()) {
                {
                    ...
                    for (ScheduledTask _iter282 : struct.tasks) {
            ...
            if (incoming.get(0)) {
                {
                    ...
                    struct.tasks = new HashSet<ScheduledTask>(2 * _set283.size);
                    ScheduledTask _elem284;
                    for (int _i285 = 0; _i285 < _set283.size; ++_i285) {
                        _elem284 = new ScheduledTask();
                        _elem284.read(iprot);
                        struct.tasks.add(_elem284);
                    }
                }
                struct.setTasksIsSet(true);
            }
